...
- Affected code: settings ViewModel and appearance tab UI, theme application service resource mapping, theme settings persistence model, localized strings, and related Avalonia headless/ViewModel tests
